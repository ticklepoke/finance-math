...
it('PV perpetuity', () => {
  expect(PVPerpetuity(0.1, 1)).toEqual(10)
})

it('PV Annuity', () => {
  expect(PVAnnuity(1, 1, 1)).toEqual(0.5)
})

it('PV growing annuity', () => {
  expect(PVGrowingAnnuity(1, 1, 0.5, 1)).toEqual(0.5)
})

it('FV annuity', () => {
  expect(FVAnnuity(1, 1, 1)).toEqual(1)
})
